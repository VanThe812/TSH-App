import { IonBackButton, IonButton, IonButtons, IonContent, IonDatetime, IonHeader, IonInput, IonItem, IonLabel, IonList, IonPage, IonRadio, IonRadioGroup, IonText, IonTitle, IonToolbar } from "@ionic/react"
  ...
  return (
    <IonPage className="personal-information-page">
      ...
      className="login-form-item-input"
        ...
        <IonRadioGroup value={userData.gender} onIonChange={(e) => handleInputChange('gender', e.detail.value)}>
            ...
            <IonRadio aria-label="Custom checkbox" slot="start" value="female" />
